  ...
  return (
    ...
    >
      <div className="container mx-auto text-center">
        ...
        <p>I&apos;m a software engineer based in Indonesia, working across the full stack but most at home on the backend — designing APIs, structuring data flows, and solving problems where the requirements are concrete.</p>
        <p>I&apos;ve spent the last several years at a Singapore-based fintech platform, working on complex API integrations, legacy codebases, and system architecture.</p>
