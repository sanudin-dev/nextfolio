...
export default function Contact() {
  return (
    <section id="contact" className="px-4 py-20 mb-10 bg-sky-950 text-gray-300 rounded-xl w-full">
      <div className="container mx-auto text-center">
        ...
        <p>
          I&apos;m currently focused on my full-time role, but I&apos;m always open to thoughtful
          conversations
        </p>
